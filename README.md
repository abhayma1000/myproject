...
project's edge node:
```bash
kubectl get svc edge-myproject -n $MY_NAMESPACE
```
...
It is up to you to get them there! Following the pattern defined in the `k8s/manifests.yaml` edge-myproject Deployment 
